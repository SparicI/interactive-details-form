...
import { defineEventHandler, handleCacheHeaders, createEvent, eventHandler, setHeaders, sendRedirect, proxyRequest, setResponseStatus, getRequestHeader, setResponseHeader, getRequestHeaders, createApp, createRouter as createRouter$1, toNodeListener, fetchWithEvent, lazyEventHandler, getQuery as getQuery$1, createError } from 'file:///Users/ivana/projects/fem/interactive-details-form/node_modules/h3/dist/index.mjs';
import { createRenderer } from 'file:///Users/ivana/projects/fem/interactive-details-form/node_modules/vue-bundle-renderer/dist/runtime.mjs';
...
const getClientManifest = () => import('/Users/ivana/projects/fem/interactive-details-form/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getStaticRenderedHead = () => Promise.resolve().then(function () { return _virtual__headStatic$1; }).then((r) => r.default || r);
const getServerEntry = () => import('/Users/ivana/projects/fem/interactive-details-form/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
