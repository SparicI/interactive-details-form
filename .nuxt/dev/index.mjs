...
import { defineEventHandler, handleCacheHeaders, isEvent, createEvent, getRequestHeader, splitCookiesString, eventHandler, setHeaders, sendRedirect, proxyRequest, setResponseHeader, send, getResponseStatus, setResponseStatus, setResponseHeaders, getRequestHeaders, createApp, createRouter as createRouter$1, toNodeListener, fetchWithEvent, lazyEventHandler, getQuery as getQuery$1, createError, getResponseStatusText } from 'file:///Users/ivana/projects/fem/interactive-details-form/node_modules/h3/dist/index.mjs';
import { getRequestDependencies, getPreloadLinks, getPrefetchLinks, createRenderer } from 'file:///Users/ivana/projects/fem/interactive-details-form/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { stringify, uneval } from 'file:///Users/ivana/projects/fem/interactive-details-form/node_modules/devalue/index.js';
import { renderToString } from 'file:///Users/ivana/projects/fem/interactive-details-form/node_modules/vue/server-renderer/index.mjs';
import { renderSSRHead } from 'file:///Users/ivana/projects/fem/interactive-details-form/node_modules/@unhead/ssr/dist/index.mjs';
import { createFetch as createFetch$1, Headers as Headers$1 } from 'file:///Users/ivana/projects/fem/interactive-details-form/node_modules/ofetch/dist/node.mjs';
...
import { parseURL, withoutBase, joinURL, getQuery, withQuery } from 'file:///Users/ivana/projects/fem/interactive-details-form/node_modules/ufo/dist/index.mjs';
...
import { version, unref } from 'file:///Users/ivana/projects/fem/interactive-details-form/node_modules/vue/index.mjs';
import { createServerHead as createServerHead$1 } from 'file:///Users/ivana/projects/fem/interactive-details-form/node_modules/unhead/dist/index.mjs';
...
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/Users/ivana/projects/fem/interactive-details-form/.data/kv","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _kghYn4pMhL = (function(nitro) {
...
const _lazy_Y6u4RP = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_Y6u4RP, lazy: true, middleware: false, method: undefined },
...
const appHead = {"meta":[{"name":"viewport","content":"width=device-width, initial-scale=1"},{"charset":"utf-8"}],"link":[],"style":[],"script":[],"noscript":[],"charset":"utf-8","viewport":"width=device-width, initial-scale=1","title":"Interactive Details Form","htmlAttrs":{"lang":"en"}};
...
const getClientManifest = () => import('file:///Users/ivana/projects/fem/interactive-details-form/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getServerEntry = () => import('file:///Users/ivana/projects/fem/interactive-details-form/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
