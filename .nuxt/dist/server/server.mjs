...
const BaseForm_vue_vue_type_style_index_0_scoped_bfb34fc5_lang = "";
...
const app_vue_vue_type_style_index_0_scoped_00600aa1_lang = "";
const _sfc_main$2 = {
  __name: "app",
  __ssrInlineRender: true,
  setup(__props) {
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = /* @__PURE__ */ defineAsyncComponent(() => import("./_nuxt/error-404-3da6eb53.js").then((r) => r.default || r));
    const _Error = /* @__PURE__ */ defineAsyncComponent(() => import("./_nuxt/error-500-00a63fe4.js").then((r) => r.default || r));
...
const _sfc_main = {
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const IslandRenderer = /* @__PURE__ */ defineAsyncComponent(() => import("./_nuxt/island-renderer-4d5703ae.js").then((r) => r.default || r));
    const nuxtApp = useNuxtApp();
