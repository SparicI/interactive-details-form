...
import { withQuery, hasProtocol, parseURL, joinURL, isEqual, stringifyParsedURL, stringifyQuery, parseQuery } from 'file:///Users/ivana/projects/fem/interactive-details-form/node_modules/ufo/dist/index.mjs';
import { createError as createError$1, sanitizeStatusCode } from 'file:///Users/ivana/projects/fem/interactive-details-form/node_modules/h3/dist/index.mjs';
...
const _sfc_main$3 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<form${ssrRenderAttrs(mergeProps({ class: "form flex-column" }, _attrs))} data-v-bfb34fc5><div class="form__group flex-column" data-v-bfb34fc5><label for="cardholderName" class="form__label" data-v-bfb34fc5> Cardholder name </label><input id="cardholderName" class="form__input" type="text" name="cardholderName"${ssrRenderAttr("value", unref(form).cardholderName)} placeholder=" e.g. Jane Appleseed" data-v-bfb34fc5></div><div class="form__group flex-column" data-v-bfb34fc5><label for="cardNumber" class="form__label" data-v-bfb34fc5> Card number </label><input id="cardNumber" class="form__input" type="text" name="cardNumber"${ssrRenderAttr("value", unref(form).cardNumber)} placeholder="e.g. 1234 5678 9123 0000" data-v-bfb34fc5></div><div class="flex-row" data-v-bfb34fc5><div class="form__group flex-column width-50" data-v-bfb34fc5><label for="number" class="form__label" data-v-bfb34fc5> Exp. date (mm/yy) </label><div class="flex-row" data-v-bfb34fc5><input id="month" class="form__input" type="text" name="month"${ssrRenderAttr("value", unref(form).month)} placeholder="MM" data-v-bfb34fc5><input id="year" class="form__input" type="text" name="year"${ssrRenderAttr("value", unref(form).year)} placeholder="YY" data-v-bfb34fc5></div></div><div class="form__group flex-column width-50" data-v-bfb34fc5><label for="cvc" class="form__label" data-v-bfb34fc5> Cvc </label><input id="cvc" class="form__input" type="number" name="cvc"${ssrRenderAttr("value", unref(form).cvc)} placeholder="e.g. 123" data-v-bfb34fc5></div></div><button type="submit" class="form__button" data-v-bfb34fc5>Confirm</button></form>`);
    };
  }
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/error-404-3da6eb53.mjs').then((r) => r.default || r));
    const _Error = /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/error-500-00a63fe4.mjs').then((r) => r.default || r));
...
const _sfc_main = {
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const IslandRenderer = /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/island-renderer-4d5703ae.mjs').then((r) => r.default || r));
    const nuxtApp = useNuxtApp();
